...
def main():
    ...
    n=2
    # Imposto qui i percorsi manualmente
    ...
    if Interpolate:
        output_path = f"C:/Users/ducci/Documents/Università_2025/6_SemesterProject/BrainGraph/output/Output_basic_extractor/BasicCenterline_00{n}_interpolated.vtp"
    # 1. Load mask
    mask, affine = load_mask(input_path)

    if Interpolate:
        # Increase resolution: more voxel separation between vessels
        mask, affine = upsample_mask(mask, affine, scale=scale)
